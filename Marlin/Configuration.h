...
#define STRING_CONFIG_H_AUTHOR "notabucketofspam" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ASM-1"
...
#define TEMP_BED_RESIDENCY_TIME 30  // (seconds) Time to wait for bed to "settle" in M190; was 10
 ...
 */
#define DEFAULT_ACCELERATION          (MOTOR_PPS/4)    // X, Y, Z and E acceleration for printing moves; was 3000
#define DEFAULT_RETRACT_ACCELERATION  (MOTOR_PPS/4)    // E acceleration for retracts; was 3000
#define DEFAULT_TRAVEL_ACCELERATION   (MOTOR_PPS/4)    // X, Y, Z acceleration for travel (non printing) moves; was 3000
...
#define PROBING_MARGIN 10 // was 10
...
#define Z_PROBE_LOW_POINT          -2 // Farthest distance below the trigger-point to go before stopping; was -2
 ...
 */
//#define PROBING_HEATERS_OFF       // Turn heaters off when probing; default off
#if ENABLED(PROBING_HEATERS_OFF)
  //#define WAIT_FOR_BED_HEATER     // Wait for bed to heat back up between probes (to improve accuracy)
#endif
//#define PROBING_FANS_OFF          // Turn fans off when probing; default off
//#define PROBING_STEPPERS_OFF      // Turn steppers off (unless needed to hold position) when probing; default off
...
#define Z_HOMING_HEIGHT  5      // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
                                  // Be sure to have this much clearance over your Z_MAX_POS to prevent grinding; was 4
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_NOZZLE_SIZE    0.1  // (mm) Diameter of primary nozzle.
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (50*60) // was (50*60)
#define HOMING_FEEDRATE_Z  (4*60) // was (4*60)
